# Upskills Campus Projects

## 📌 Overview
This repository contains multiple projects developed during my **Upskill Campus Internship**.  
Each project demonstrates different aspects of Python programming, logic building, and software development.  
The goal is to build a portfolio of practical applications that highlight problem-solving, coding skills, and project structuring.
...
- **Project 3: Password Manager**  
  A secure password manager built with Python and CustomTkinter.  
